...
func (c *SheetsClient) LoginIdentity(ctx context.Context, matricula string) (LoginIdentity, error) {
	...
	if err != nil {
		return LoginIdentity{}, NewHTTPError(503, "não conseguiu acessar a planilha de login; verifique GOOGLE_SHEET_IDS, credencial da service account e compartilhamento da planilha")
	}
